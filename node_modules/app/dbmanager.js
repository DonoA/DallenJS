...
GLOBAL.ConnStr = JSON.parse(fs.readFileSync('config.json', 'utf8')).sqlConn;

GLOBAL.Channels = JSON.parse(fs.readFileSync('config.json', 'utf8')).twitchChannels;

GLOBAL.Maps = JSON.parse(fs.readFileSync('config.json', 'utf8')).Maps;

GLOBAL.SSL = JSON.parse(fs.readFileSync('config.json', 'utf8')).ssl;
...
var DBmanager = {
    getTwitchStats: function(channel, callback){
